...
export default function Login(){
 ...
 async function handleSubmit(e){
    ...
    <Form.Control type="username" ref={emailRef} placeholder="Enter Email" name='email' required />
    <Form.Text   >
    </Form.Text>
    </Form.Group>
    ...
    <Form.Control type="password" ref={passwordRef} placeholder="Password" name='password'  required />
    <Form.Text   >
    </Form.Text>
    </Form.Group>
